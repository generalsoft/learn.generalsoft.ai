...
const navLinks = [
  { name: 'Home', path: '/' },
  { name: 'AI for Business', path: '/business' },
  { name: 'AI for Schools', path: '/schools' },
        ...
        <div className="flex items-center justify-between h-12">
          ...
          <Link to="/" className="flex items-center space-x-2.5 focus-ring rounded-lg">
            ...
            <div>
              ...
              <span className="text-xs font-semibold text-primary-600 tracking-wider uppercase">AI Training · UAE</span>
            </div>
          </Link>
